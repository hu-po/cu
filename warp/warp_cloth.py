...
class Example:
    def __init__(
        ...
        usd_stage = Usd.Stage.Open(os.path.join(warp.examples.get_asset_directory(), "bunny.usd")) # TODO: replace with needle.usd
        usd_geom = UsdGeom.Mesh(usd_stage.GetPrimAtPath("/root/bunny")) # needle mesh should be at this path in usd file
